  ...
  public jobsList: Company[] = [
    ...
    },
    {
      ...
      jobs: [
        {
          url:
            'https://www.anexia-it.com/de/unternehmen/karriere/full-stack-developer-mfd/',
          description: 'Full Stack Developer (m/w/d)',
        },
        {
          url:
            'https://www.anexia-it.com/de/unternehmen/karriere/python-developer-mwd/',
    ...
    },
    {
      ...
      jobs: [
        {
          url:
            'https://www.apa-it.at/Site/jobs/javascript_frontend_developer.de.html',
    ...
    },
    {
      ...
      jobs: [
        {
          url:
            'https://apc.co.at/project-managers.php?positionID=6033&hv=1e988437751cfea66e72c5847f0fb0cb',
          description:
            'Junior Frontend Developer für Industry 4.0 und AI Applikationen (w/m)',
        },
        {
          url:
            'https://apc.co.at/project-managers.php?positionID=5982&hv=4e3858e1425d69ba4f65101101d7f49c',
