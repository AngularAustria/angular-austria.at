    ...
    return (
      <div class="app-events">
        <div class="content__jumbotron">
          <img src="assets/imgs/photo-organize.jpg" alt="Angular Meetup Group" class="content__jumbotron-img"/>
        ...
        <section class="content__past">
          ...
          <div class="content__past-events-info wrapper--base">
            <h2>Past Events</h2>
            <app-meetup-widget queryParams="past" pageCount="1" displayOrder={true}></app-meetup-widget>
            <a href="https://www.meetup.com/Angular-Vienna/events/past" class="btn">
              Show More
            </a>
          </div>
          </nice-anim>
